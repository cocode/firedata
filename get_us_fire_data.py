...
def get_annual_acres_helper(all_data, year, previous_data=None, cumulative=False):
    return stats.get_annual_acres_helper(all_data, year=year, previous_data=previous_data,
                                         get_unique_id=get_unique_id, get_size=get_size, cumulative=cumulative)
...
def get_annual_acres(ds:DataStore, year, state=None):
    ...
    return get_annual_acres_helper(all_data, year=year, previous_data=previous_data, cumulative=True)
